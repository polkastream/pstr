...
- **10% Seed Funding:** 5% of the total tokens are unlocked during the $PSTR Token Generation Event (TGE) with a one-month cliff, followed by twelve months of linear unlock.
...
- **21% Team and Advisors:** All tokens are locked for 180 days outright, followed by 2.5% of the 210 million PSTR unlocking once every 30 days.  

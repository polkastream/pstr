...
# Tokenomics
PSTR is minted on Binance Smart Chain (BSC) with an initial maximum supply of one billion (1,000,000,000) tokens. This BEP-20 token is built with an Automated Farming (AF) feature that includes:
